...
mouse_metadata_highfat_rep8 <- read_excel("C:/Users/mdm2000/OneDrive - USNH/PeroPhysiology/mouse_data.xlsx", 
    sheet = "rep8_highfat", col_types = c("text", 
        "numeric", "numeric", "text", "text", 
        "numeric", "text", "text", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
...
mouse_metadata_highfat_rep9 <- read_excel("C:/Users/mdm2000/OneDrive - USNH/PeroPhysiology/mouse_data.xlsx", 
    sheet = "rep9_highfat", col_types = c("text", 
        "numeric", "numeric", "text", "text", 
        "numeric", "text", "text", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
...
```{r import physiology and temp data message=FALSE, warning=FALSE, echo=FALSE}
...
hdr7_temps <- bring_in_temps_highfat_rep7("temps_highfat_rep7.csv")

#this is the physiology data for the dehydration part of the highfat experiment rep8

path <- "C:/Users/mdm2000/OneDrive - USNH/PeroPhysiology/data/highfat_dehydration_rep8/"
hdr8 <- bring_in_data_highfat_rep8("highfat_dehydrated_rep8.csv")
hdr8 <- hdr8 %>% mutate(DateTime = with_tz(DateTime, tz="EST"))
hdr8_act <- read_csv("C:/Users/mdm2000/OneDrive - USNH/PeroPhysiology/data/highfat_dehydration_rep8/highfat_dehydrated_rep8_activity.csv", n_max=dim(hdr8)[1])

hdr8_temps <- bring_in_temps_highfat_rep8("highfat_temps_rep8.csv")

#this is the physiology data for the dehydration part of the highfat experiment rep7

path <- "C:/Users/mdm2000/OneDrive - USNH/PeroPhysiology/data/highfat_dehydration_rep9/"
hdr9 <- bring_in_data_highfat_rep9("highfat_dehydrated_rep9.csv")
hdr9 <- hdr9 %>% mutate(DateTime = with_tz(DateTime, tz="EST"))
hdr9_act <- read_csv("C:/Users/mdm2000/OneDrive - USNH/PeroPhysiology/data/highfat_dehydration_rep9/highfat_dehydrated_rep9_activity.csv", n_max=dim(hdr9)[1])

hdr9_temps <- bring_in_temps_highfat_rep9("temps_rep9.csv")
...
```{r manipulate data REP8}


############# subset temp data

target <- c(1,2,3,4,5,7)
hdr8_temps_select <- hdr8_temps %>% 
  filter(AntennaID %in% target)

hdr8_temps <- hdr8_temps_select

################### hdr8

#make activity data non-cumulative
hdr8 <- hdr8 %>% 
  add_column(MOD_ADX = hdr8_act$MOD_ADX) %>%
  mutate(Activity = MOD_ADX - lag(MOD_ADX, default = 0))
...
for (DV in dependent_variables){
  print(DV)
    model <- lm(as.formula(paste0(DV, " ~ Animal_ID")), data = hdr8_cages)
  model.metrics <- augment(model) %>% dplyr::select(-.hat, -.sigma, -.fitted)
  summ <- model.metrics %>% filter(abs(.std.resid) > 2) %>% as.data.frame()
  ...
  for (each_outlier_row in 1:nrow(summ)){
    this_weight <- summ[each_outlier_row, "Animal_ID"]
    this_DV  <- summ[each_outlier_row, DV]
    OL_list <- c(OL_list, (which(hdr8_cages$Animal_ID == this_weight & hdr8_cages[DV] == this_DV)))
...
highfat_dehydration_noOL_rep8 <- hdr8_cages[-c(masterlist_noDup),]
```

```{r manipulate data REP9}


############# subset temp data

target <- c(1,3,6,7)
hdr9_temps_select <- hdr9_temps %>% 
  filter(AntennaID %in% target)

hdr9_temps <- hdr9_temps_select

################### hdr9

#make activity data non-cumulative
hdr9 <- hdr9 %>% 
  add_column(MOD_ADX = hdr9_act$MOD_ADX) %>%
  mutate(Activity = MOD_ADX - lag(MOD_ADX, default = 0))
...
for (DV in dependent_variables){
  print(DV)
    model <- lm(as.formula(paste0(DV, " ~ Animal_ID")), data = hdr9_cages)
  model.metrics <- augment(model) %>% dplyr::select(-.hat, -.sigma, -.fitted)
  summ <- model.metrics %>% filter(abs(.std.resid) > 2) %>% as.data.frame()
  ...
  for (each_outlier_row in 1:nrow(summ)){
    this_weight <- summ[each_outlier_row, "Animal_ID"]
    this_DV  <- summ[each_outlier_row, DV]
    OL_list <- c(OL_list, (which(hdr9_cages$Animal_ID == this_weight & hdr9_cages[DV] == this_DV)))
...
highfat_dehydration_noOL_rep9 <- hdr9_cages[-c(masterlist_noDup),]
```
...
rep8_water_removal <- ymd_hms("2023-04-07 11:00:59", tz="EST")
baseline_rep8 <- interval(rep8_water_removal - days(1), rep8_water_removal)
day1_rep8 <- interval(rep8_water_removal, rep8_water_removal + days(1))

baseline_temp_rep8 <- interval(rep8_water_removal - days(1), rep8_water_removal)

### REP9
### Animals sac'd 2 days after water removal

rep9_water_removal <- ymd_hms("2023-05-23 11:30:59", tz="EST")
baseline_rep9 <- interval(rep9_water_removal - days(1), rep9_water_removal)
day1_rep9 <- interval(rep9_water_removal, rep9_water_removal + days(1))
day2_rep9 <- interval(rep9_water_removal + days(1), rep9_water_removal + days(2))

baseline_temp_rep9 <- interval(rep9_water_removal - days(1), rep9_water_removal)
...
highfat_dehydration_noOL_rep8 <- highfat_dehydration_noOL_rep8 %>%
    mutate(replicate = "rep8")

highfat_dehydration_noOL_rep8 <- highfat_dehydration_noOL_rep8 %>%
    add_column(experiment_day = NA)

highfat_dehydration_noOL_rep8$experiment_day[highfat_dehydration_noOL_rep8$DateTime %within% baseline_rep8 == "TRUE"] <- "baseline"
highfat_dehydration_noOL_rep8$experiment_day[highfat_dehydration_noOL_rep8$DateTime %within% day1_rep8 == "TRUE"] <- "day1"
write.csv(highfat_dehydration_noOL_rep8, "highfat_dehydration_rep8.csv", row.names = FALSE)
...
highfat_dehydration_noOL_rep9 <- highfat_dehydration_noOL_rep9 %>%
    mutate(replicate = "rep9")

highfat_dehydration_noOL_rep9 <- highfat_dehydration_noOL_rep9 %>%
    add_column(experiment_day = NA)


highfat_dehydration_noOL_rep9$experiment_day[highfat_dehydration_noOL_rep9$DateTime %within% baseline_rep9 == "TRUE"] <- "baseline"
highfat_dehydration_noOL_rep9$experiment_day[highfat_dehydration_noOL_rep9$DateTime %within% day1_rep9 == "TRUE"] <- "day1"
highfat_dehydration_noOL_rep9$experiment_day[highfat_dehydration_noOL_rep9$DateTime %within% day2_rep9 == "TRUE"] <- "day2"
write.csv(highfat_dehydration_noOL_rep9, "highfat_dehydration_rep9.csv", row.names = FALSE)
```
...
highfat_baseline_temps <-
  rbind(hdr1_temps[hdr1_temps$DateTime %within% baseline_temp_rep1,],
        ...
        hdr5_temps[hdr5_temps$DateTime %within% baseline_temp_rep5,],
        hdr7_temps[hdr7_temps$DateTime %within% baseline_temp_rep7,],
        hdr8_temps[hdr8_temps$DateTime %within% baseline_temp_rep8,],
        hdr9_temps[hdr9_temps$DateTime %within% baseline_temp_rep9,])
...
highfat_day1_temps <-
  rbind(hdr1_temps[hdr1_temps$DateTime %within% day1_rep1,],
        ...
        hdr5_temps[hdr5_temps$DateTime %within% day1_rep5,],
        hdr7_temps[hdr7_temps$DateTime %within% day1_rep7,],
        hdr8_temps[hdr8_temps$DateTime %within% day1_rep8,],
        hdr9_temps[hdr9_temps$DateTime %within% day1_rep9,])
...
highfat_day2_temps <-
  rbind(hdr1_temps[hdr1_temps$DateTime %within% day2_rep1,],
        ...
        hdr5_temps[hdr5_temps$DateTime %within% day2_rep5,],
        hdr9_temps[hdr9_temps$DateTime %within% day2_rep9,])
...
highfat_day3_temps <-
  rbind(hdr1_temps[hdr1_temps$DateTime %within% day3_rep1,],
        ...
        hdr5_temps[hdr5_temps$DateTime %within% day3_rep5,])



###PHYSIOLOGY

highfat_baseline_physio <- 
  rbind(highfat_dehydration_noOL_rep1[highfat_dehydration_noOL_rep1$DateTime %within% baseline_rep1,],
        ...
        highfat_dehydration_noOL_rep5[highfat_dehydration_noOL_rep5$DateTime %within% baseline_rep5,],
        highfat_dehydration_noOL_rep7[highfat_dehydration_noOL_rep7$DateTime %within% baseline_rep7,],
        highfat_dehydration_noOL_rep8[highfat_dehydration_noOL_rep8$DateTime %within% baseline_rep8,],
        highfat_dehydration_noOL_rep9[highfat_dehydration_noOL_rep9$DateTime %within% baseline_rep9,])
...
highfat_day1_physio <-
  rbind(highfat_dehydration_noOL_rep1[highfat_dehydration_noOL_rep1$DateTime %within% day1_rep1,],
        ...
        highfat_dehydration_noOL_rep5[highfat_dehydration_noOL_rep5$DateTime %within% day1_rep5,],
        highfat_dehydration_noOL_rep7[highfat_dehydration_noOL_rep7$DateTime %within% day1_rep7,],
        highfat_dehydration_noOL_rep8[highfat_dehydration_noOL_rep8$DateTime %within% day1_rep8,],
        highfat_dehydration_noOL_rep9[highfat_dehydration_noOL_rep9$DateTime %within% day1_rep9,])
...
highfat_day2_physio <-
  rbind(highfat_dehydration_noOL_rep1[highfat_dehydration_noOL_rep1$DateTime %within% day2_rep1,],
        ...
        highfat_dehydration_noOL_rep5[highfat_dehydration_noOL_rep5$DateTime %within% day2_rep5,],
        highfat_dehydration_noOL_rep9[highfat_dehydration_noOL_rep9$DateTime %within% day2_rep9,])
...
highfat_day3_physio <-
  rbind(highfat_dehydration_noOL_rep1[highfat_dehydration_noOL_rep1$DateTime %within% day3_rep1,],
        ...
        highfat_dehydration_noOL_rep5[highfat_dehydration_noOL_rep5$DateTime %within% day3_rep5,])

all_data <- rbind(highfat_dehydration_noOL_rep1,highfat_dehydration_noOL_rep2,highfat_dehydration_noOL_rep3,highfat_dehydration_noOL_rep4,highfat_dehydration_noOL_rep5,highfat_dehydration_noOL_rep7,highfat_dehydration_noOL_rep8,highfat_dehydration_noOL_rep9)

all_temps <- rbind(highfat_baseline_temps,highfat_day1_temps,highfat_day2_temps,highfat_day3_temps)
...
#[1] "1205 removed" "1137 good" "1207 good" "1258 removed" "1401 removed" "1308 removed" "1305 removed" "1320 removed" "1134 good" "1239 good" "1016good" "1251 bad" "1255 bad" "1140 good" "1163 good" "1208 good" "1234 good" "1236 good" "1404 good"
#[20] "1202 good" "1241 good" "1262 good" "1250 good"

problem_animal <- 1250

coeff <- 0
cols <- c("Baseline"="navyblue","Day 1"="sienna1","Day 2"="sienna3", "Day 3"="sienna4")
prob_temp <- ggplot(data = highfat_baseline_temps %>% filter(Animal_ID == problem_animal) ,aes(x=as.POSIXct(time),y=body_temp)) +
  ...
  geom_point(data = highfat_day1_temps %>% filter(Animal_ID == problem_animal), aes(color="Day 1", alpha=0.2), shape=20, size=1)+
  geom_point(data = highfat_day2_temps %>% filter(Animal_ID == problem_animal), aes(color="Day 2", alpha=0.2), shape=20, size=1)+
  geom_point(data = highfat_day3_temps %>% filter(Animal_ID == problem_animal)%>% filter(Animal_ID == "1137"), aes(color="Day 3", alpha=0.2), shape=20, size=1)+
  theme_classic()+
  labs(x = "")+
...
```{r check temps to make sure we hvae all the animals}

set1 <- unique(hdr1_temps$Animal_ID)
set2 <- unique(hdr2_temps$Animal_ID)
set3 <- unique(hdr3_temps$Animal_ID)
set4 <- unique(hdr4_temps$Animal_ID)
set5 <- unique(hdr5_temps$Animal_ID)
set7 <- unique(hdr7_temps$Animal_ID)
set8 <- unique(hdr8_temps$Animal_ID)
set9 <- unique(hdr9_temps$Animal_ID)

sort(c(set1,set2,set3,set4,set5,set7,set8,set9))


#animal 1236 exists in rep2 and rep5
...
coeff <- 0
cols <- c("Baseline"="navyblue","Day 1"="sienna1","Day 2"="sienna3", "Day 3"="sienna4")
temperatures <- ggplot(data = highfat_baseline_temps ,aes(x=as.POSIXct(time),y=body_temp)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("rect", xmin = as.POSIXct("1970-01-01 00:00:01", tz="UTC"), 
           xmax = as.POSIXct("1970-01-01 06:00:00", tz="UTC"), 
           ymin = -Inf, ymax = Inf, fill="grey84") +
  ...
  geom_point(data = highfat_day1_temps, aes(color="Day 1", alpha=0.2), shape=20, size=0.5)+
  geom_point(data = highfat_day2_temps, aes(color="Day 2", alpha=0.2), shape=20, size=0.5)+
  geom_point(data = highfat_day3_temps, aes(color="Day 3", alpha=0.2), shape=20, size=0.5)+
  ...
  geom_smooth(data = highfat_day1_temps, method='gam', se = FALSE, aes(color = "Day 1"), size=2)+
  geom_smooth(data = highfat_day2_temps, method='gam', se = FALSE, aes(color = "Day 2"), size=2)+
  geom_smooth(data = highfat_day3_temps, method='gam', se = FALSE, aes(color = "Day 3"), size=2)+
  labs(x = "")+
...
EE <- ggplot(data = highfat_baseline_physio,aes(x=as.POSIXct(time),y=EE_kJH)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("rect", xmin = as.POSIXct("1970-01-01 00:00:01", tz="UTC"), 
           xmax = as.POSIXct("1970-01-01 06:00:00", tz="UTC"), 
           ymin = -Inf, ymax = Inf, fill="grey84") +
  ...
  geom_point(data = highfat_day1_physio, aes(color="Day 1", alpha=0.2))+
  geom_point(data = highfat_day2_physio, aes(color="Day 2", alpha=0.2))+
  geom_point(data = highfat_day3_physio, aes(color="Day 3", alpha=0.2))+
  theme_classic()+
  ylim(0,1.5) +
  geom_smooth(method='gam', se = FALSE, aes(color = "Baseline"))+
  geom_smooth(data = highfat_day1_physio, method='gam', se = FALSE, aes(color = "Day 1"))+
  geom_smooth(data = highfat_day2_physio, method='gam', se = FALSE, aes(color = "Day 2"))+
  geom_smooth(data = highfat_day3_physio, method='gam', se = FALSE, aes(color = "Day 3"))+
...
activity <- ggplot(data = highfat_baseline_physio,aes(x=as.POSIXct(time),y=Activity)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("rect", xmin = as.POSIXct("1970-01-01 00:00:01", tz="UTC"), 
           xmax = as.POSIXct("1970-01-01 06:00:00", tz="UTC"), 
           ymin = -Inf, ymax = Inf, fill="grey84") +
...
water <- ggplot(data = highfat_baseline_physio,aes(x=as.POSIXct(time),y=H2Omg)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("rect", xmin = as.POSIXct("1970-01-01 00:00:01", tz="UTC"), 
           xmax = as.POSIXct("1970-01-01 06:00:00", tz="UTC"), 
           ymin = -Inf, ymax = Inf, fill="grey84") +
...
EE <- ggplot(data = highfat_day1_physio,aes(x=as.POSIXct(time),y=EE_kJH)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("rect", xmin = as.POSIXct("1970-01-01 00:00:01", tz="UTC"), 
           xmax = as.POSIXct("1970-01-01 06:00:00", tz="UTC"), 
           ymin = -Inf, ymax = Inf, fill="grey84") +
  annotate("rect", xmin = as.POSIXct("1970-01-01 21:00:00", tz="UTC"), 
           xmax = as.POSIXct("1970-01-01 23:59:59", tz="UTC"), 
           ymin = -Inf, ymax = Inf, fill="grey84") +
  geom_point(aes(color = "Day 1", alpha=0.1))+
  #geom_point(data = highfat_day1_physio, aes(color="Day 1", alpha=0.2))+
  #geom_point(data = highfat_day2_physio, aes(color="Day 2", alpha=0.2))+
  #geom_point(data = highfat_day3_physio, aes(color="Day 3", alpha=0.2))+
  theme_classic()+
  ylim(0,1.5) +
  geom_smooth(method='gam', se = FALSE, aes(color = "Day 1"))+
  #geom_smooth(data = highfat_day1_physio, method='gam', se = FALSE, aes(color = "Day 1"))+
  #geom_smooth(data = highfat_day2_physio, method='gam', se = FALSE, aes(color = "Day 2"))+
  #geom_smooth(data = highfat_day3_physio, method='gam', se = FALSE, aes(color = "Day 3"))+
  labs(x = "", y = expression(EE ~ (KiloJoules ~ h^-1)))+
